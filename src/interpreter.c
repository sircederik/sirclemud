...
cpp_extern const struct command_info cmd_info[] = {
  ...
  { "avanzar"  , POS_DEAD    , do_advance  , LVL_IMPL, 0 },
  ...
  { "autosalidas" , POS_DEAD    , do_gen_tog  , 0, SCMD_AUTOEXIT },
  ...
  { "reir"    , POS_RESTING , do_action   , 0, 0 },
  { "ultimo"     , POS_DEAD    , do_last     , LVL_GOD, 0 },
  { "irse"    , POS_STANDING, do_leave    , 0, 0 },
  { "niveles"   , POS_DEAD    , do_levels   , 0, 0 },
  { "lista"     , POS_STANDING, do_not_here , 0, 0 },
  { "lick"     , POS_RESTING , do_action   , 0, 0 },
  { "asegurar"     , POS_SITTING , do_gen_door , 0, SCMD_LOCK },
  { "cargar"     , POS_DEAD    , do_load     , LVL_GOD, 0 },
  { "amar"     , POS_RESTING , do_action   , 0, 0 },
  ...
  { "ordenar"    , POS_RESTING , do_order    , 1, 0 },
  { "ofertar"    , POS_STANDING, do_not_here , 1, 0 },
  ...
  { "agitar"    , POS_RESTING , do_action   , 0, 0 },
  { "shiver"   , POS_RESTING , do_action   , 0, 0 },
  { "mostrar"     , POS_DEAD    , do_show     , LVL_IMMORT, 0 },
  { "shrug"    , POS_RESTING , do_action   , 0, 0 },
  { "shutdow"  , POS_DEAD    , do_shutdown , LVL_IMPL, 0 },
  { "desconectar" , POS_DEAD    , do_shutdown , LVL_IMPL, SCMD_SHUTDOWN },
  { "sigh"     , POS_RESTING , do_action   , 0, 0 },
  { "cantar"     , POS_RESTING , do_action   , 0, 0 },
  ...
  { "boladenieve" , POS_STANDING, do_action   , LVL_IMMORT, 0 },
  ...
  { "pararse"    , POS_RESTING , do_stand    , 0, 0 },
  ...
  { "desbloquear"   , POS_SITTING , do_gen_door , 0, SCMD_UNLOCK },
  { "desagrupar"  , POS_DEAD    , do_ungroup  , 0, 0 },
  ...
  { "usuarios"    , POS_DEAD    , do_users    , LVL_IMMORT, 0 },

  { "valor"    , POS_STANDING, do_not_here , 0, 0 },
  ...
  { "vestir"     , POS_RESTING , do_wear     , 0, 0 },
  { "clima"  , POS_RESTING , do_weather  , 0, 0 },
  { "quien"      , POS_DEAD    , do_who      , 0, 0 },
  { "yo"   , POS_DEAD    , do_gen_ps   , 0, SCMD_WHOAMI },
  { "donde"    , POS_RESTING , do_where    , 1, 0 },
  { "susurrar"  , POS_RESTING , do_spec_comm, 0, SCMD_WHISPER },
  ...
  { "escribir"    , POS_STANDING, do_write    , 1, 0 },
