...
cpp_extern const struct command_info cmd_info[] = {
  ...
  { "norte"    , POS_STANDING, do_move     , 0, SCMD_NORTH },
  { "este"     , POS_STANDING, do_move     , 0, SCMD_EAST },
  { "sur"    , POS_STANDING, do_move     , 0, SCMD_SOUTH },
  { "oeste"     , POS_STANDING, do_move     , 0, SCMD_WEST },
  { "arriba"       , POS_STANDING, do_move     , 0, SCMD_UP },
  { "abajo"     , POS_STANDING, do_move     , 0, SCMD_DOWN },

  /* now, the main list */
  { "at"       , POS_DEAD    , do_at       , LVL_IMMORT, 0 },
  { "advance"  , POS_DEAD    , do_advance  , LVL_IMPL, 0 },
  { "alias"    , POS_DEAD    , do_alias    , 0, 0 },
  { "acusar"   , POS_SITTING , do_action   , 0, 0 },
  { "aplaudir"  , POS_RESTING , do_action   , 0, 0 },
  { "asistir"   , POS_FIGHTING, do_assist   , 1, 0 },
  { "preguntar"      , POS_RESTING , do_spec_comm, 0, SCMD_ASK },
  { "auction"  , POS_SLEEPING, do_gen_comm , 0, SCMD_AUCTION },
  { "autoexit" , POS_DEAD    , do_gen_tog  , 0, SCMD_AUTOEXIT },

  { "rebotar"   , POS_STANDING, do_action   , 0, 0 },
  ...
  { "sangrar"    , POS_RESTING , do_action   , 0, 0 },
  ...
  { "eructar"     , POS_RESTING , do_action   , 0, 0 },
  { "comprar"      , POS_STANDING, do_not_here , 0, 0 },
  ...
  { "cerrar"    , POS_SITTING , do_gen_door , 0, SCMD_CLOSE },
  { "cls"      , POS_DEAD    , do_gen_ps   , 0, SCMD_CLEAR },
  { "considerar" , POS_RESTING , do_consider , 0, 0 },
  { "color"    , POS_DEAD    , do_color    , 0, 0 },
  { "comfort"  , POS_RESTING , do_action   , 0, 0 },
  { "comb"     , POS_RESTING , do_action   , 0, 0 },
  { "comandos" , POS_DEAD    , do_commands , 0, SCMD_COMMANDS },
  { "compactar"  , POS_DEAD    , do_gen_tog  , 0, SCMD_COMPACT },
  { "cough"    , POS_RESTING , do_action   , 0, 0 },
  { "creditos"  , POS_DEAD    , do_gen_ps   , 0, SCMD_CREDITS },
  { "cringe"   , POS_RESTING , do_action   , 0, 0 },
  { "llorar"      , POS_RESTING , do_action   , 0, 0 },
  { "cuddle"   , POS_RESTING , do_action   , 0, 0 },
  { "curse"    , POS_RESTING , do_action   , 0, 0 },
  { "curtsey"  , POS_STANDING, do_action   , 0, 0 },

  { "bailar"    , POS_STANDING, do_action   , 0, 0 },
  { "fecha"     , POS_DEAD    , do_date     , LVL_IMMORT, SCMD_DATE },
  { "daydream" , POS_SLEEPING, do_action   , 0, 0 },
  { "dc"       , POS_DEAD    , do_dc       , LVL_GOD, 0 },
  { "depositar"  , POS_STANDING, do_not_here , 1, 0 },
  { "diagnosticar" , POS_RESTING , do_diagnose , 0, 0 },
  { "display"  , POS_DEAD    , do_display  , 0, 0 },
  { "donar"   , POS_RESTING , do_drop     , 0, SCMD_DONATE },
  { "beber"    , POS_RESTING , do_drink    , 0, SCMD_DRINK },
  { "soltar"     , POS_RESTING , do_drop     , 0, SCMD_DROP },
  { "drool"    , POS_RESTING , do_action   , 0, 0 },

  { "comer"      , POS_RESTING , do_eat      , 0, SCMD_EAT },
  ...
  { "entrar"    , POS_STANDING, do_enter    , 0, 0 },
  { "equipo", POS_SLEEPING, do_equipment, 0, 0 },
  { "salidas"    , POS_RESTING , do_exits    , 0, 0 },
  { "examinar"  , POS_SITTING , do_examine  , 0, 0 },

  { "forzar"    , POS_SLEEPING, do_force    , LVL_GOD, 0 },
  { "pedorrear"     , POS_RESTING , do_action   , 0, 0 },
  { "llenar"     , POS_STANDING, do_pour     , 0, SCMD_FILL },
  { "flee"     , POS_FIGHTING, do_flee     , 1, 0 },
  { "flip"     , POS_STANDING, do_action   , 0, 0 },
  { "flirt"    , POS_RESTING , do_action   , 0, 0 },
  { "segir"   , POS_RESTING , do_follow   , 0, 0 },
  { "fondle"   , POS_RESTING , do_action   , 0, 0 },
  { "congelar"   , POS_DEAD    , do_wizutil  , LVL_FREEZE, SCMD_FREEZE },
  { "french"   , POS_RESTING , do_action   , 0, 0 },
  { "frown"    , POS_RESTING , do_action   , 0, 0 },
  { "fume"     , POS_RESTING , do_action   , 0, 0 },

  { "tomar"      , POS_RESTING , do_get      , 0, 0 },
  { "gasp"     , POS_RESTING , do_action   , 0, 0 },
  { "gecho"    , POS_DEAD    , do_gecho    , LVL_GOD, 0 },
  { "dar"     , POS_RESTING , do_give     , 0, 0 },
  ...
  { "chismear"   , POS_SLEEPING, do_gen_comm , 0, SCMD_GOSSIP },
  { "group"    , POS_RESTING , do_group    , 1, 0 },
  { "agarrar"     , POS_RESTING , do_grab     , 0, 0 },
  ...
  { "matar"     , POS_FIGHTING, do_kill     , 0, 0 },
  { "patear"     , POS_FIGHTING, do_kick     , 1, 0 },
  { "besar"     , POS_RESTING , do_action   , 0, 0 },

  { "mirar"     , POS_RESTING , do_look     , 0, SCMD_LOOK },
  { "laugh"    , POS_RESTING , do_action   , 0, 0 },
  { "last"     , POS_DEAD    , do_last     , LVL_GOD, 0 },
  { "dejar"    , POS_STANDING, do_leave    , 0, 0 },
  { "niveles"   , POS_DEAD    , do_levels   , 0, 0 },
  { "listar"     , POS_STANDING, do_not_here , 0, 0 },
  ...
  { "correo"     , POS_STANDING, do_not_here , 1, 0 },
  { "mensaje"  , POS_RESTING , do_action   , 0, 0 },
  { "silenciar"     , POS_DEAD    , do_wizutil  , LVL_GOD, SCMD_SQUELCH },
  { "asesinar"   , POS_FIGHTING, do_hit      , 0, SCMD_MURDER },

  { "noticias"     , POS_SLEEPING, do_gen_ps   , 0, SCMD_NEWS },
  ...
  { "abrir"     , POS_SITTING , do_gen_door , 0, SCMD_OPEN },

  { "poner"      , POS_RESTING , do_put      , 0, 0 },
  ...
  { "quitar"     , POS_DEAD    , do_quit     , 0, SCMD_QUIT },
  { "qsay"     , POS_RESTING , do_qcomm    , 0, SCMD_QSAY },

  { "responder"    , POS_SLEEPING, do_reply    , 0, 0 },
  { "descansar"     , POS_RESTING , do_rest     , 0, 0 },
  { "leer"     , POS_RESTING , do_look     , 0, SCMD_READ },
  { "recargar"   , POS_DEAD    , do_reboot   , LVL_IMPL, 0 },
  { "recitar"   , POS_RESTING , do_use      , 0, SCMD_RECITE },
  { "recibir"  , POS_STANDING, do_not_here , 1, 0 },
  { "remover"   , POS_RESTING , do_remove   , 0, 0 },
  { "rentar"     , POS_STANDING, do_not_here , 1, 0 },
  { "reportar"   , POS_RESTING , do_report   , 0, 0 },
  { "reroll"   , POS_DEAD    , do_wizutil  , LVL_GRGOD, SCMD_REROLL },
  { "rescatar"   , POS_FIGHTING, do_rescue   , 1, 0 },
  { "restaurar"  , POS_DEAD    , do_restore  , LVL_GOD, 0 },
  ...
  { "decir"      , POS_RESTING , do_say      , 0, 0 },
  { "'"        , POS_RESTING , do_say      , 0, 0 },
  { "salvar"     , POS_SLEEPING, do_save     , 0, 0 },
  { "score"    , POS_DEAD    , do_score    , 0, 0 },
  { "gritar"   , POS_RESTING , do_action   , 0, 0 },
  { "vender"     , POS_STANDING, do_not_here , 0, 0 },
  { "mandar"     , POS_SLEEPING, do_send     , LVL_GOD, 0 },
  ...
  { "olfatear"    , POS_RESTING , do_action   , 0, 0 },
  ...
  { "aplastar"  , POS_RESTING , do_action   , 0, 0 },
  ...
  { "tiempo"   , POS_DEAD    , do_date     , LVL_IMMORT, SCMD_UPTIME },
...
void command_interpreter(struct char_data *ch, char *argument)
{
  ...
  if (*cmd_info[cmd].command == '\n')
    ...
    send_to_char(ch, "Intentas pero el frío intenso te lo impide...\r\n");
  else if (cmd_info[cmd].command_pointer == NULL)
    send_to_char(ch, "Lo lamento pero el comando no ha sido implementado... aún.\r\n");
  else if (IS_NPC(ch) && cmd_info[cmd].minimum_level >= LVL_IMMORT)
    send_to_char(ch, "No puedes utilizar comandos de inmortales cuando estás intercambiado.\r\n");
  else if (GET_POS(ch) < cmd_info[cmd].minimum_position)
    switch (GET_POS(ch)) {
    case POS_DEAD:
      send_to_char(ch, "Quedate ahí, frío, bien muerto...!!! :-(\r\n");
      break;
    case POS_INCAP:
    case POS_MORTALLYW:
      send_to_char(ch, "Estas en muy mala condición, no puedes hacer nada, estas incapacitado!!\r\n");
      break;
    case POS_STUNNED:
      send_to_char(ch, "Todo lo que puedes hacer ahora es contemplar las estrellas\r\n");
      break;
    case POS_SLEEPING:
      send_to_char(ch, "en tus sueños, o qué?\r\n");
      break;
    case POS_RESTING:
      send_to_char(ch, "Te sientes muuuy relajado para hacer eso...\r\n");
      break;
    case POS_SITTING:
      send_to_char(ch, "Podrias considerar ponerte de pie primero?\r\n");
      break;
    case POS_FIGHTING:
      send_to_char(ch, "De ninguna manera, estas luchando por tu vida ahora mismo!!!\r\n");
      break;
...
ACMD(do_alias)
{
  ...
  if (!*arg) {			/* no argument specified -- list currently defined aliases */
    send_to_char(ch, "Aliases actualmente definidos:\r\n");
    if ((a = GET_ALIASES(ch)) == NULL)
      send_to_char(ch, " Ninguno.\r\n");
    else {
      while (a != NULL) {
    ...
    if (!*repl) {
      if (a == NULL)
	send_to_char(ch, "No existe tal alias.\r\n");
      else
	send_to_char(ch, "Alias eliminado.\r\n");
    } else {			/* otherwise, either add or redefine an alias */
      if (!str_cmp(arg, "alias")) {
	send_to_char(ch, "No puedes hacer alias de 'alias'.\r\n");
	return;
      }
	...
	a->type = ALIAS_SIMPLE;
      ...
      GET_ALIASES(ch) = a;
      send_to_char(ch, "Alias agregado.\r\n");
    }
  }
}
...
int perform_dupe_check(struct descriptor_data *d)
{
  ...
  */
  ...
  case RECON:
    ...
    act("$n se ha reconectado.", TRUE, d->character, 0, 0, TO_ROOM);
    mudlog(NRM, MAX(LVL_IMMORT, GET_INVIS_LEV(d->character)), TRUE, "%s [%s] has reconnected.", GET_NAME(d->character), d->host);
    break;
  case USURP:
    write_to_output(d, "Ahora estas sobre tu propio cuerpo, actualmente en uso!\r\n");
...
void nanny(struct descriptor_data *d, char *arg)
{
  ...
  case CON_GET_NAME:		/* wait for input of name */
	...
	write_to_output(d, "Nombre inválido, por favor utiliza otro.\r\nNombre: ");
	return;
      }
	...
	if (PLR_FLAGGED(d->character, PLR_DELETED)) {
	  ...
	  GET_PFILEPOS(d->character) = player_i;
	  write_to_output(d, "Lo entendí correctamente, %s (Y/N)? ", tmp_name);
  ...
  case CON_NAME_CNFRM:		/* wait for conf. of new name    */
	...
	return;
      ...
      if (circle_restrict) {
	write_to_output(d, "Lo lamento, no es posible crear nuevos jugadores de momento.\r\n");
	mudlog(NRM, LVL_GOD, TRUE, "Request for new char %s denied from [%s] (wizlock)", GET_PC_NAME(d->character), d->host);
	STATE(d) = CON_CLOSE;
	return;
      }
      write_to_output(d, "Nuevo personaje.\r\nDame un password para %s: ", GET_PC_NAME(d->character));
      echo_off(d);
      STATE(d) = CON_NEWPASSWD;
    } else if (*arg == 'n' || *arg == 'N') {
      write_to_output(d, "Bien bien, ¿Cuál es entonces? ");
      free_char(d->character);
